...
const HeroSlideshow: React.FC<HeroSlideshowProps> = ({ onExploreClick }) => {
  const slides = [
    {
      id: 1,
      title: "Find the Perfect Products for Your Dog",
      description: "Discover personalized recommendations based on your dog's breed, size, and needs",
    ...
    },
    {
      ...
      description: "Connect with other dog owners, share experiences, and get expert advice",
                ...
                <div className="container mx-auto px-4">
                  <div className="max-w-2xl">
                    ...
                    {slide.link ? (
                      ...
                      >
                        {slide.theme === 'black-friday' ? 'Shop Black Friday Deals' : 'Learn More'}
