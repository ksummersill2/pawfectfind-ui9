...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    if (isAuthenticated && isAdmin) {
      console.log('User is authenticated and admin, redirecting to:', from);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!success) {
        ...
        console.error('Login failed: Invalid credentials or unauthorized access');
      } else {
        console.log('Login successful, admin status:', success);
      }
    } catch (err) {
